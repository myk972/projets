...
namespace GoogleGeocoder
{
    ...
    public class Geocode
    {
        ...
        private const string _googleKey = "AIzaSyCKpA4c8lsJXHJjXtxpAbKZGUPkVuOSKoM"; // Get your key from:  http://www.google.com/apis/maps/signup.html
        ...
        public static Coordinate GetCoordinates(string address)
        {
            ...
            geocodeInfo[2] = geocodeInfo[2].Replace(".", ",");
            geocodeInfo[3] = geocodeInfo[3].Replace(".", ",");
